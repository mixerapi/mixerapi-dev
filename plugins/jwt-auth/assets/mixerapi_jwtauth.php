...
return [
    'MixerApi.JwtAuth' => [
         ...
         * `bin/cake mixerapi:jwtauth keygen hmac` or something like `openssl rand -base64 32`
         */
         ...
         * key length must be at least 2048 bits, not be committed to your VCS, and stored securely. You can
         * generate keys using `bin/cake mixerapi:jwtauth keygen rsa` or via openssl.
         */
        'keys' => [
            [
                /*
